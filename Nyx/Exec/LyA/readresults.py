...
print (f"Nyx simulation with Baseline solution time: {time_1:.2f} seconds")
print (f"Baseline overhead compared to computation only: {perc_1:.1f} %")
print (f"-------------------- Previous --------------------")
print (f"Baseline: no compression, no asynchronous write.")
print (f"Nyx simulation with Baseline solution time: {time_2:.2f} seconds")
print (f"Baseline overhead compared to computation only: {perc_2:.1f} %")
print (f"---------------------- Ours ----------------------")
print (f"Baseline: no compression, no asynchronous write.")
print (f"Nyx simulation with Baseline solution time: {time_3:.2f} seconds")
print (f"Baseline overhead compared to computation only: {perc_3:.1f} %")
print (f"------------------- Improvement ------------------")
